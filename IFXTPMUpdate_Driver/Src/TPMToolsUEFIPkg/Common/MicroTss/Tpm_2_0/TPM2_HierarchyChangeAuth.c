...
)
{
    ...
    do
    {
        ...
        TSS_TPM_CC commandCode = TSS_TPM_CC_HierarchyChangeAuth;
        // Response parameters
        ...
        unReturnValue = TSS_TPM2B_AUTH_Marshal(pNewAuth, &pbBuffer, &nSizeRemaining);
        if (RC_SUCCESS != unReturnValue)
            break;
