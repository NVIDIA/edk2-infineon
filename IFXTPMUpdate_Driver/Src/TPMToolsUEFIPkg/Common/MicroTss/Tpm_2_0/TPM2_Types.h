...
#define TSS_TPM_CLOCK_COARSE_SLOWER             (TSS_TPM_CLOCK_ADJUST)(-3)
#define TSS_TPM_CLOCK_MEDIUM_SLOWER             (TSS_TPM_CLOCK_ADJUST)(-2)
#define TSS_TPM_CLOCK_FINE_SLOWER               (TSS_TPM_CLOCK_ADJUST)(-1)
...
typedef struct _TSS_TPMA_LOCALITY {
    unsigned int TSS_TPM_LOC_ZERO               : 1;
    unsigned int TSS_TPM_LOC_ONE                : 1;
    unsigned int TSS_TPM_LOC_TWO                : 1;
    unsigned int TSS_TPM_LOC_THREE              : 1;
    unsigned int TSS_TPM_LOC_FOUR               : 1;
    unsigned int TSS_Extended                   : 3;    /**
