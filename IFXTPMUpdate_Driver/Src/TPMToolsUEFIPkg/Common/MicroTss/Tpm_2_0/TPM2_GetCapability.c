...
)
{
    ...
    do
    {
        ...
        TSS_TPM_CC commandCode = TSS_TPM_CC_GetCapability;
        // Response parameters
        ...
        Platform_MemorySet(pMoreData, 0x00, sizeof(TSS_TPMI_YES_NO));
        Platform_MemorySet(pCapabilityData, 0x00, sizeof(TSS_TPMS_CAPABILITY_DATA));
        // Marshal the request
        pbBuffer = rgbRequest;
